...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=363295');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "363295");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "724688ad610455c3f3a6766794d03a01b2099583a6cb765920761c9f6d40a02c");
define('CREATED_TIMESTAMP', "1685175659");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor363295');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor363295');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "plug-rush-adult-sds.pages.dev",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "plug-rush-adult-sds.pages.dev",
));
